...
public class CarlDuckEntityModel extends GeoModel<CarlDuckEntity> {
    ...
    public ResourceLocation getModelResource(CarlDuckEntity object, @Nullable GeoRenderer<CarlDuckEntity> renderer) {
        if ("god".equalsIgnoreCase(object.getName().getString()) || "angel".equalsIgnoreCase(object.getName().getString())
            ...
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "geo/carl_cult_leader.geo.json");
        } else if ("braincell".equalsIgnoreCase(object.getName().getString()) || "braincells".equalsIgnoreCase(object.getName().getString())) {
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "geo/braincells.geo.json");
        } else if ("hooty".equalsIgnoreCase(object.getName().getString()) || "hootsifer".equalsIgnoreCase(object.getName().getString())) {
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "geo/hoot.geo.json");
        } else if ("bok_choy".equalsIgnoreCase(object.getName().getString()) || "bok_choyo".equalsIgnoreCase(object.getName().getString())) {
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "geo/bok_choy.geo.json");
        } else if ("egg".equalsIgnoreCase(object.getName().getString())) {
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "geo/egg.geo.json");
        }
        else return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "geo/carl.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(CarlDuckEntity animatable) {
        if ("god".equalsIgnoreCase(animatable.getName().getString()) || "angel".equalsIgnoreCase(animatable.getName().getString())
            ...
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "animations/biblically_accurate_carl.animation.json");
        } else if ("lamb".equalsIgnoreCase(animatable.getName().getString()) || "cult_leader".equalsIgnoreCase(animatable.getName().getString())) {
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "animations/carl_cult_leader.animation.json");
        } else if ("hooty".equalsIgnoreCase(animatable.getName().getString()) || "hootsifer".equalsIgnoreCase(animatable.getName().getString())) {
            return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "animations/hoot.animation.json");
        }
        else return ResourceLocation.fromNamespaceAndPath(CarlMod.MODID, "animations/carl.animation.json");
    }
